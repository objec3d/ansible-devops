...
from mas.devops.backup import downloadFromS3
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        local_dir = self._task.args.get('local_dir', None)
        ...
        if local_dir is None:
            raise AnsibleError(f"Error: local_dir argument was not provided")
